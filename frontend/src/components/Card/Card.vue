...
<template>
  <div
    class="flex flex-col items-center justify-between w-full p-6 bg-slate-100 rounded-lg md:flex-row"
    :id="id"
  >
    <router-link
      :to="`/company/${props.searchResult.symbol}/company-profile`"
      class="font-bold text-center text-veryDarkViolet md:text-left"
    >
